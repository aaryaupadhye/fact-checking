...
def main():
    ...
    model, tokenizer = utils.load_model(model_name="../../datasets/Llama-2-13b-chat-hf") 
    
    # # For inference on Llama-2-70b-chat
    # model, tokenizer = utils.load_model(model_name="../../datasets/Llama-2-70b-chat-hf")  
    ...
    for element in json_data:        
        ...
        Context:
        - Is it true that the composer of Longplayer was a banjo player? -> yes
        - Is it true that the composer of Longplayer was in a band. -> yes
        - Is it true that James McNally was a musician. -> yes
        - Is it true that James McNally was in the same band as the composer of LongPlayer. -> yes
        \n
        The context is inline with the claim, Therefore, the answer is 'SUPPORTED'.
        ...
        \n
        Claim: 'This work and a production Francesco Tortoli made sets for in 1987 are both operas. Maria de Francesca-Cavazza performed in this opera.'
        Context:
        - Did Maria de Francesca-Cavezza perform in an opera?  -> yes
        - Did maria de Francesia-Cavezza perform an opera in 1987? -> no
        - Did Francesco Tortoli make sets for an opera? -> yes
        - Did Francesco Tortoli make sets for this opera in 1987? -> no
        \n
        The context is not inline with the claim, Therefore, the answer is 'NOT_SUPPORTED'.
        ...
        \n
        Claim: 'Red, White & Crüe and this athlete both fight. The french fighter was trained by Bobby Stewart.'
        Context:
        - Is it true that Red, White & Crüe and this athlete both fight? -> yes
        - Is it true that the fighter was trained by Bobby Stewart. -> yes
        - Is it true that the french fighter was trained by Bobby Stewart. -> no
        \n
        The context is not inline with the claim, Therefore, the answer is 'NOT_SUPPORTED'.
        ...
        \n
        Claim: 'Skagen Painter Peder Severin Krøyer favored naturalism along with Theodor Esbern Philipsen and the artist Ossian Elgström studied with in the early 1900s.'
        Context:
        - Did Skagen Painter Peder Severin Krøyer favor naturalism? -> yes
        - Did Theodor Esbern Philipsen favor naturalism? -> yes
        - Did the artist Ossian Elgström studied with in the early 1900s favor naturalism? -> yes
        \n
        The context is inline with the claim, Therefore, the answer is 'SUPPORTED'.
        ...
        \n
        Claim : 'The DAF XF articulated truck is produced by Leyland Trucks at their Farington plant.'
        Context:
        - Is the DAF XF truck produced by Leyland Trucks? -> yes
        - Is the DAF XF articulated truck produced by Leyland Trucks? -> no
        - Is the DAF XF truck produced at their Farington plant? -> yes
        - Is the DAF XF articulated truck is produced at their Farington plant? -> no
        \n
        The context is not inline with the claim, Therefore, the answer is 'NOT_SUPPORTED'.
        ...
        \n
        Context:
        - Did WWE Super Tuesday take place at an arena? -> yes
        - Does that arena currently go by the name TD Garden? -> yes
        \n
        The context is inline with the claim, Therefore, the answer is 'SUPPORTED'.
        ...
        for p in prompts:
            ...
            output = model.generate(input_ids, 
                                    num_return_sequences=1, max_new_tokens=150)
